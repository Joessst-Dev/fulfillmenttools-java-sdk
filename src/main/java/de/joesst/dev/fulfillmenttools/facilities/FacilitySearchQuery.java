...
public final class FacilitySearchQuery {
    ...
    /** Returns the facility ID filter. @return the ID filter */
    public Map<String, Object> id() { return id; }

    /** Returns the facility name filter. @return the name filter */
    public Map<String, Object> name() { return name; }

    /** Returns the facility status filter. @return the status filter */
    public Map<String, Object> status() { return status; }

    /** Returns the facility type filter. @return the type filter */
    public Map<String, Object> type() { return type; }

    /** Returns the facility location type filter. @return the location type filter */
    public Map<String, Object> locationType() { return locationType; }

    /** Returns the tenant facility ID filter. @return the tenant facility ID filter */
    public Map<String, Object> tenantFacilityId() { return tenantFacilityId; }

    /** Returns the facility address filter. @return the address filter */
    public Map<String, Object> address() { return address; }

    /** Returns the facility contact filter. @return the contact filter */
    public Map<String, Object> contact() { return contact; }

    /** Returns the referenced entities filter. @return the referenced filter */
    public Map<String, Object> referenced() { return referenced; }

    /** Returns the facility services filter. @return the services filter */
    public Map<String, Object> services() { return services; }

    /** Returns the facility tags filter. @return the tags filter */
    public Map<String, Object> tags() { return tags; }

    /** Returns the AND-combined sub-queries. @return the AND queries */
    public List<FacilitySearchQuery> and() { return and; }

    /** Returns the OR-combined sub-queries. @return the OR queries */
    public List<FacilitySearchQuery> or() { return or; }

    public static Builder builder() { return new Builder(); }

    /** Builder for FacilitySearchQuery. */
    public static final class Builder {

        /** The facility ID filter. */
        private Map<String, Object> id;

        /** The facility name filter. */
        ...
        /** The facility location type filter. */
        private Map<String, Object> locationType;

        /** The tenant facility ID filter. */
        private Map<String, Object> tenantFacilityId;

        /** The facility address filter. */
        private Map<String, Object> address;

        /** The facility contact filter. */
        private Map<String, Object> contact;

        /** The referenced entities filter. */
        private Map<String, Object> referenced;

        /** The facility services filter. */
        private Map<String, Object> services;

        /** The facility tags filter. */
        private Map<String, Object> tags;

        /** The AND-combined sub-queries. */
        private List<FacilitySearchQuery> and;

        /** The OR-combined sub-queries. */
        private List<FacilitySearchQuery> or;

        /** Creates a new Builder. */
        public Builder() {}

        /** Sets an equality filter on facility ID. @param value the value. @return this builder */
        public Builder idEq(String value) { id = Map.of("eq", value); return this; }

        /** Sets an in-list filter on facility ID. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on facility ID. @param value the value. @return this builder */
        public Builder idNotEq(String value) { id = Map.of("notEq", value); return this; }

        /** Sets an equality filter on facility name. @param value the value. @return this builder */
        public Builder nameEq(String value) { name = Map.of("eq", value); return this; }

        /** Sets a pattern filter on facility name. @param pattern the pattern. @return this builder */
        public Builder nameLike(String pattern) { name = Map.of("like", pattern); return this; }

        /** Sets an in-list filter on facility name. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on facility name. @param value the value. @return this builder */
        public Builder nameNotEq(String value) { name = Map.of("notEq", value); return this; }

        /** Sets an equality filter on facility status. @param value the value. @return this builder */
        public Builder statusEq(String value) { status = Map.of("eq", value); return this; }

        /** Sets an in-list filter on facility status. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on facility status. @param value the value. @return this builder */
        public Builder statusNotEq(String value) { status = Map.of("notEq", value); return this; }

        /** Sets an equality filter on facility type. @param value the value. @return this builder */
        public Builder typeEq(String value) { type = Map.of("eq", value); return this; }

        /** Sets an in-list filter on facility type. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on facility type. @param value the value. @return this builder */
        public Builder typeNotEq(String value) { type = Map.of("notEq", value); return this; }

        /** Sets an equality filter on location type. @param value the value. @return this builder */
        public Builder locationTypeEq(String value) { locationType = Map.of("eq", value); return this; }

        /** Sets an in-list filter on location type. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on location type. @param value the value. @return this builder */
        public Builder locationTypeNotEq(String value) { locationType = Map.of("notEq", value); return this; }

        /** Sets an equality filter on tenant facility ID. @param value the value. @return this builder */
        public Builder tenantFacilityIdEq(String value) { tenantFacilityId = Map.of("eq", value); return this; }

        /** Sets an in-list filter on tenant facility ID. @param values the values. @return this builder */
        ...
        /** Sets a not-equal filter on tenant facility ID. @param value the value. @return this builder */
        public Builder tenantFacilityIdNotEq(String value) { tenantFacilityId = Map.of("notEq", value); return this; }

        /** Sets an equality filter on city. @param value the value. @return this builder */
        public Builder cityEq(String value) { return addr("city", Map.of("eq", value)); }

        /** Sets a pattern filter on city. @param pattern the pattern. @return this builder */
        public Builder cityLike(String pattern) { return addr("city", Map.of("like", pattern)); }

        /** Sets an equality filter on country. @param value the value. @return this builder */
        public Builder countryEq(String value) { return addr("country", Map.of("eq", value)); }

        /** Sets a pattern filter on country. @param pattern the pattern. @return this builder */
        public Builder countryLike(String pattern) { return addr("country", Map.of("like", pattern)); }

        /** Sets an equality filter on postal code. @param value the value. @return this builder */
        public Builder postalCodeEq(String value) { return addr("postalCode", Map.of("eq", value)); }

        /** Sets a pattern filter on postal code. @param pattern the pattern. @return this builder */
        public Builder postalCodeLike(String pattern) { return addr("postalCode", Map.of("like", pattern)); }

        /** Sets an equality filter on street. @param value the value. @return this builder */
        public Builder streetEq(String value) { return addr("street", Map.of("eq", value)); }

        /** Sets an equality filter on company name. @param value the value. @return this builder */
        public Builder companyNameEq(String value) { return addr("companyName", Map.of("eq", value)); }

        /** Sets an equality filter on province. @param value the value. @return this builder */
        public Builder provinceEq(String value) { return addr("province", Map.of("eq", value)); }

        /** Sets a nested filter on contact. @param filter the filter. @return this builder */
        public Builder contact(Map<String, Object> filter) { contact = filter; return this; }

        /** Sets a nested filter on referenced entities. @param filter the filter. @return this builder */
        public Builder referenced(Map<String, Object> filter) { referenced = filter; return this; }

        /** Sets a nested filter on services. @param filter the filter. @return this builder */
        public Builder services(Map<String, Object> filter) { services = filter; return this; }

        /** Sets a nested filter on tags. @param filter the filter. @return this builder */
        public Builder tags(Map<String, Object> filter) { tags = filter; return this; }

        /** Combines sub-queries with AND. @param queries the queries. @return this builder */
        ...
        /** Combines sub-queries with OR. @param queries the queries. @return this builder */
        ...
        /** Builds and returns a new FacilitySearchQuery. @return the built query */
