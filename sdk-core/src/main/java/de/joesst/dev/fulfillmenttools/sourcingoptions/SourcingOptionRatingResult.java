...
import de.joesst.dev.fulfillmenttools.id.RatingResultId;
import de.joesst.dev.fulfillmenttools.id.RatingResultType;
import de.joesst.dev.fulfillmenttools.id.RoutingStrategyNodeId;
...
public record SourcingOptionRatingResult(
        ...
        String name,
        Double penalty,
        RatingResultType type,
        RoutingStrategyNodeId routingStrategyNodeId
) {
    ...
    public static final class Builder {
        ...
        private RatingResultId id;
        private String name;
        private Double penalty;
        private RatingResultType type;
        private RoutingStrategyNodeId routingStrategyNodeId;

        public Builder id(RatingResultId id) { this.id = id; return this; }
        public Builder name(String name) { this.name = name; return this; }
        public Builder penalty(Double penalty) { this.penalty = penalty; return this; }
        public Builder type(RatingResultType type) { this.type = type; return this; }
        public Builder routingStrategyNodeId(RoutingStrategyNodeId routingStrategyNodeId) { this.routingStrategyNodeId = routingStrategyNodeId; return this; }
